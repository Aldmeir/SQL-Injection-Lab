...
if ($category !== 'all') {
    $sql = "SELECT * FROM products WHERE category != '' AND category = '$category' ";
}
else{
...
<body>
    <nav>
        <ul>
            ...
            <?php if (!isset($_SESSION['username'])): ?>
                <!-- Giriş yapılmamışsa login ve register sayfaları görünür -->
                <li><a href="login.php">Giriş</a></li>
                <li><a href="register.php">Kayıt Ol</a></li>
            <?php else: ?>
                <!-- Giriş yapılmışsa login ve register sayfaları gizlenir -->
    ...
    <main>
        <h2>Ürünler</h2>
        <div class="filter">
            <a href="urunler.php?category=all"><button>Tümü</button></a>
            <a href="urunler.php?category=elektronik"><button>Elektronik</button></a>
            <a href="urunler.php?category=giyim"><button>Giyim</button></a>
            <a href="urunler.php?category=gida"><button>Gıda</button></a>
        </div>
